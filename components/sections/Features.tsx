        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight">
              중고차 사이트, 중고차 유튜브를 보시면서<br />
              원하는 차량을 찾고 계신가요?
            </h2>
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              이제 더 이상 찾아 헤매지 마시고 트루카에 주문하세요<br />
              <span className="text-blue-600 font-medium">20년 경력의 트루카</span>가 내가 찾는 그 차량을 찾아 드립니다
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-8 shadow-xl transition-transform hover:scale-105 duration-300">
              <div className="mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">일단, 주문해 보세요</h3>
                <p className="text-gray-700 text-lg">
                  전문 상담사가 내게 맞는 차량을 찾아드립니다. 
                  특별한 요구사항도 정확하게 파악하여 최적의 차량을 제안해 드립니다.
                </p>
              </div>
              <div className="bg-white rounded-xl p-4 shadow-sm">
                <div className="flex gap-2 items-center text-blue-600">
                  ...
                  <p className="font-medium">상담사의 전문성</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-white rounded-2xl p-8 shadow-xl transition-transform hover:scale-105 duration-300">
              <div className="mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">어떤 비용도 들지 않습니다</h3>
                <p className="text-gray-700 text-lg">
                  인터넷에서 보신 주소를 복사해 넣으시기만 해도 됩니다.
                  상담부터 차량 검색까지 무료로 제공해 드립니다.
                </p>
              </div>
              <div className="bg-white rounded-xl p-4 shadow-sm">
                <div className="flex gap-2 items-center text-indigo-600">
                  ...
                  <p className="font-medium">무료 상담 서비스</p>
                </div>
              </div>
            </div>
          </div>
